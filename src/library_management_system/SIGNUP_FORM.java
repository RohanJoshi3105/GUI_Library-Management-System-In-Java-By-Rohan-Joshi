...
public class SIGNUP_FORM extends javax.swing.JFrame {
    ...
    private void SUBMIT_BUTTONActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SUBMIT_BUTTONActionPerformed
        // TODO add your handling code here:
         ...
         String pwd1=new String(pass2.getPassword());
            ...
            if(pwd.equals(pwd1))
        {
            ...
            String query1="insert into employee_login(employee_name,employee_password) values('"+username+"','"+pwd+"') ;";
       ...
       // if(user.getText().equals("Rohan")&&pwd.equals("rj")){
